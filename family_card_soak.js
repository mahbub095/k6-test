...
//           under sustained moderate load over an extended period.
// Pattern : Ramp to moderate load → hold for a long time → ramp down.

export const options = {
  stages: [
    { duration: '2m',  target: 100 },  // ramp up to 100 VUs
    { duration: '2m',  target: 200 },  // ramp up to 200 VUs
    { duration: '56m', target: 200 },  // hold at 200 VUs for 56 minutes (total 1 hour)
    { duration: '5m',  target: 0   },  // ramp down
  ],
  thresholds: {
    // Soak thresholds are strict — degradation over time should not occur
