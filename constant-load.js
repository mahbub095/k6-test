 ...
 * Constant Load Test
 *
 * Purpose: Verify system stability under a fixed load sustained over a long
 *          period. 500 VUs run for 30 minutes to expose memory leaks, resource
 *          exhaustion, or other long-running issues.
 *
 * How to run:
...
export default function () {
    ...
    const pageRes = http.get(`${BASE_URL}admin/login`, {
        timeout: '30s',
        tags: { step: 'get-login-page', test: 'constant-load' },
    });
    requestCount.add(1);
